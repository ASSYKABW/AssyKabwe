...
document.querySelectorAll('.feature-card, .content-card, .testimonial-card, .pricing-card').forEach(el => {
...
style.textContent = `
    ...
    .resource-meta span, .insight-meta span {
        display: flex;
        align-items: center;
        gap: 0.3rem;
    }
...
console.log('CareerBoost website loaded successfully!');